import { defineComponent, ref, toRef, watchEffect, openBlock, createElementBlock, normalizeClass, normalizeStyle, renderSlot, inject, watch, Fragment, renderList, createVNode, unref, createCommentVNode } from "vue";
  ...
  setup(__props, { emit: emits }) {
    ...
    watch(
      [() => props.minWidth, () => props.minHeight, () => props.maxWidth, () => props.maxHeight, () => {
        var _a;
        return (_a = node.value) == null ? void 0 : _a.initialized;
      }],
